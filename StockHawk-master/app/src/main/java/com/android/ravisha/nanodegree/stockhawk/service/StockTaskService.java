...
public class StockTaskService extends GcmTaskService{
  private String LOG_TAG = com.android.ravisha.nanodegree.stockhawk.service.StockTaskService.class.getSimpleName();
    ...
    if (urlStringBuilder != null){
      ...
      try{
        ...
        try {
          ...
          if(list != null ) {
            mContext.getContentResolver().applyBatch(StockConstants.AUTHORITY,
                    list);
          }else{
